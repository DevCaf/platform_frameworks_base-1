...
public class TileQueryHelper {
    ...
    private void addSystemTiles(final QSTileHost host) {
        String possible = mContext.getString(R.string.quick_settings_tiles_default)
                + ",hotspot,inversion,saver,work,cast,night,caffeine,heads_up,screenshot,reboot,sound,navigation_bar,adb_network,sync,expanded_desktop,usb_tether,ime,nfc,volume,nebula";
